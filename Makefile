...
.PHONY: gomarkdoc
gomarkdoc: $(GOMARKDOC) ## Download gomarkdoc locally if necessary. 
$(GOMARKDOC): | $(LOCALBIN)
	GOBIN=$(LOCALBIN) go install github.com/princjef/gomarkdoc/cmd/gomarkdoc@$(GOMARKDOC_VERSION)
